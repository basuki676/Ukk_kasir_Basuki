                ...
                <div class="row justify-content-end">
                    <div class="col-md-6">
                        <div class="border p-3 rounded">
                            @php
                                // Calculate original total price (sum of all detail sales)
                                $originalTotal = $S->detailSales->sum('sub_total');
                                // Calculate points earned (1% of original total)
                                $pointsEarned = floor($originalTotal * 0.01);
                            @endphp
